...
```
> The problem is that, for the vegetables that have plots, it is creating a distinct case for every plot that vegetable type is found in. These are not unique cases as we are going from 781 cases to 1,164. To fix this, we might want to try using the distinct() function.
...
```{r cache=TRUE}
data_site <- 
  "https://www.macalester.edu/~dshuman1/data/112/2014-Q4-Trips-History-Data-Small.rds" #change small to big
